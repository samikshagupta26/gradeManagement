...
CourseRepository courseRepository;
	...
	public void run(String... args) throws Exception {
		...
		Student[] sList={
			...
			new Student( "Harry", LocalDate.parse("1980-11-22")),
			
			new Student( "Sam", LocalDate.parse("1980-10-22")),
			
			new Student( "Murphy", LocalDate.parse("1980-12-22")),
			
			new Student( "Ron", LocalDate.parse("1980-05-22")),
			
			new Student( "Sammy", LocalDate.parse("1980-01-22")),
			
					};
			
			
					for(int i =0;i<sList.length;i++){
						studentRepository.save(sList[i]);
					}
